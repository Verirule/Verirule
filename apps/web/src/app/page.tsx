      ...
      <main>
        <section className="border-b border-slate-800/80">
          <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:py-24">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-400">Regulatory Operations Platform</p>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Button asChild size="lg" className="bg-slate-100 text-slate-950 hover:bg-white">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-slate-700 bg-transparent text-slate-100 hover:bg-slate-900/70"
              >
        ...
        <section id="problem" className="border-b border-slate-800/80">
          <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:py-20">
            <h2 className="text-2xl font-semibold text-white sm:text-3xl">Problem</h2>
        ...
        <section id="components" className="border-b border-slate-800/80">
          <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:py-20">
            <h2 className="text-2xl font-semibold text-white sm:text-3xl">System Components</h2>
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              {systemComponents.map((item) => (
                <article key={item.title} className="rounded-xl border border-slate-800 bg-slate-900/50 p-6">
        ...
        <section id="audit-ready" className="border-b border-slate-800/80">
          <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:py-20">
            <h2 className="text-2xl font-semibold text-white sm:text-3xl">Audit-Ready</h2>
            <p className="mt-4 max-w-4xl text-sm leading-relaxed text-slate-300 sm:text-base">
        ...
        <section id="integrations" className="border-b border-slate-800/80">
          <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:py-20">
            <h2 className="text-2xl font-semibold text-white sm:text-3xl">Integrations</h2>
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              {integrationItems.map((item) => (
                <article key={item.name} className="rounded-xl border border-slate-800 bg-slate-900/50 p-6">
        ...
        <section id="who-its-for" className="border-b border-slate-800/80">
          <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:py-20">
            <h2 className="text-2xl font-semibold text-white sm:text-3xl">Who It&apos;s For</h2>
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              {audience.map((item) => (
                <article key={item.title} className="rounded-xl border border-slate-800 bg-slate-900/50 p-6">
                  <h3 className="text-lg font-semibold text-white">{item.title}</h3>
