...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#F4FBF7] text-[#123928]">
      ...
      <main>
        <section className="border-b-2 border-[#C5E4D3]">
          <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:py-24">
            <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[#006F34]">Regulatory Operations Platform</p>
            <h1 className="mt-4 max-w-3xl text-4xl font-bold tracking-tight text-[#0B3A27] sm:text-5xl lg:text-6xl">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Button asChild size="lg" className="border-2 border-[#005E31] bg-[#006F34] text-white hover:bg-[#005E31]">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-2 border-[#9CCCB2] bg-white text-[#0D4C2F] hover:bg-[#EDF7F1]"
              >
        ...
        <section id="problem" className="border-b-2 border-[#C5E4D3]">
        ...
        <section id="components" className="border-b-2 border-[#C5E4D3]">
          <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:py-20">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              {systemComponents.map((item, index) => (
                <article
                  key={item.title}
                  className={`rounded-xl border-2 p-6 shadow-[0_3px_0_0_rgba(20,78,51,0.12)] ${
        ...
        <section id="audit-ready" className="border-b-2 border-[#C5E4D3]">
          <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:py-20">
        ...
        <section id="integrations" className="border-b-2 border-[#C5E4D3]">
          <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:py-20">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              {integrationItems.map((item, index) => (
                <article
                  key={item.name}
                  className={`rounded-xl border-2 border-[#C5E4D3] p-6 shadow-[0_3px_0_0_rgba(20,78,51,0.12)] ${
                    index % 2 === 0 ? "bg-white" : "bg-[#EDF7F1]"
                  }`}
                >
        ...
        <section id="who-its-for" className="border-b-2 border-[#C5E4D3]">
          <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:py-20">
        ...
        <section className="border-b-2 border-[#C5E4D3]">
          <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:py-20">
            <div className="rounded-2xl border-2 border-[#4E9974] bg-[#066335] p-8 shadow-[0_4px_0_0_rgba(16,84,52,0.45)] sm:p-10">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <Button asChild size="lg" className="border-2 border-[#B9DECA] bg-white text-[#0D4C2F] hover:bg-[#EDF7F1]">
                  <Link href="/auth/sign-up">Create account</Link>
                </Button>
                <Button
                  asChild
                  size="lg"
                  variant="outline"
                  className="border-2 border-[#B9DECA] bg-transparent text-white hover:bg-[#005E31]/50"
                >
