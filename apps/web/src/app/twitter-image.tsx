  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <defs>
            <linearGradient id="vrBlueTW" x1="38" y1="46" x2="152" y2="230" gradientUnits="userSpaceOnUse">
              <stop stopColor="#19A6FF" />
              <stop offset=".55" stopColor="#0C67CF" />
              <stop offset="1" stopColor="#003B98" />
            </linearGradient>
            <linearGradient id="vrGreenTW" x1="124" y1="44" x2="226" y2="230" gradientUnits="userSpaceOnUse">
              <stop stopColor="#76DD3C" />
              <stop offset=".55" stopColor="#22A849" />
              <stop offset="1" stopColor="#00773C" />
            </linearGradient>
            <linearGradient id="vrCircuitTW" x1="132" y1="143" x2="206" y2="50" gradientUnits="userSpaceOnUse">
              <stop stopColor="#28B24A" />
              <stop offset="1" stopColor="#62D955" />
            </linearGradient>
            <linearGradient id="vrBlueBevelTW" x1="75" y1="120" x2="138" y2="175" gradientUnits="userSpaceOnUse">
              <stop stopColor="#0B67C7" />
              <stop offset="1" stopColor="#073C94" />
            </linearGradient>
            <linearGradient id="vrGreenBevelTW" x1="132" y1="143" x2="210" y2="188" gradientUnits="userSpaceOnUse">
              <stop stopColor="#18A94A" />
              <stop offset="1" stopColor="#086B37" />
            </linearGradient>
            <clipPath id="vrShieldClipTW">
              <path d="M128 18C159 36 189 43 214 48V136C214 184 184 218 128 238C72 218 42 184 42 136V48C67 43 97 36 128 18Z" />
            </clipPath>
            <mask id="vrShieldMaskTW" maskUnits="userSpaceOnUse" x="0" y="0" width="256" height="256">
          ...
          <g clipPath="url(#vrShieldClipTW)" mask="url(#vrShieldMaskTW)">
            <rect x="0" y="0" width="128" height="256" fill="url(#vrBlueTW)" />
            <rect x="128" y="0" width="128" height="256" fill="url(#vrGreenTW)" />
          </g>

          <g clipPath="url(#vrShieldClipTW)">
            <path d="M83 143 107 120 132 143V168L106 142 90 158 73 142Z" fill="url(#vrBlueBevelTW)" opacity=".95" />
            <path d="M132 143 206 70V98L132 171Z" fill="url(#vrGreenBevelTW)" opacity=".92" />
          </g>
          ...
          <path
            ...
            strokeWidth="1.4"
          />
          <path d="M132 143 163 112V86" stroke="url(#vrCircuitTW)" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M132 143 182 93V68" stroke="url(#vrCircuitTW)" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M132 143 206 69V44" stroke="url(#vrCircuitTW)" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" />
