...
async function proxyToApi(request: NextRequest, method: "GET" | "PUT"): Promise<NextResponse> {
  ...
  try {
    const upstream = await fetchWithTimeout(
      `${apiBaseUrl}/api/v1/me/notifications`,
      {
        method,
        headers: {
    ...
    console.error("me notifications proxy failed", { request_id: requestId });
